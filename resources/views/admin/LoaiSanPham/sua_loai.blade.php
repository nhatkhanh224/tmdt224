        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="{{ url('/admin/sualoai/'.$chitiet_loaisp->id_loaisp)}}" name="themloai" id="themloai" novalidate="novaldate">
              	{{csrf_field()}}
                <div class="card-body">
                 <div class="form-group">
                        <label>Loại sản phẩm</label>
                        <input type="text" class="form-control" value="{{$chitiet_loaisp->tenloai}}" placeholder="Enter ..." name="tenloai" id="tenloai">
                 </div>
                 <div class="form-group">
                        <label>Select</label>
                        <select class="form-control" name="parent_id_loaisp">
                           @foreach($levels as $val)
                      <option value="{{$val->id_loaisp}}" @if($val->id_loaisp == $chitiet_loaisp->parent_id_loaisp)
                         selected @endif>{{$val->tenloai}}</option>
                         @endforeach
                        </select>
                      </div>
                 <div class="form-group">
                        <label>Miêu tả</label>
                        <textarea class="form-control" rows="3" placeholder="Enter ..."  name="mieuta" id="mieuta">{{$chitiet_loaisp->mieuta}}</textarea>
                      </div>
                <div class="form-group">
                        <label>URL</label>
                        <input type="text" class="form-control"  value="{{$chitiet_loaisp->url}}"  placeholder="Enter ..."  name="url" id="url">
                 </div>
