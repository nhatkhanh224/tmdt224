        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="{{url('/admin/themloai')}}" name="themloai" id="themloai" enctype="multipart/form-data">
              	{{csrf_field()}}
                <div class="card-body">
                 <div class="form-group">
                        <label>Loại sản phẩm</label>
                        <input type="text" class="form-control" placeholder="Enter ..." name="tenloai" id="tenloai">
                 </div>
                 <div class="form-group">
                        <label>Select</label>
                  	...
                  	<option value="{{$val->id_loaisp}}">{{$val->tenloai}}</option>
                  	@endforeach
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="anh_loai" name="anh_loai">
                  ...
                  <div class="form-group">
                        <label>URL</label>
                        <input type="text" class="form-control" placeholder="Enter ..." name="url" id="url">
                 </div>
