        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" enctype="multipart/form-data" method="post" action="{{url('/admin/themma')}}" name="themma" id="themma">
              	{{csrf_field()}}
                <div class="card-body">
                  
                 <div class="form-group">
                        <label>Mã giảm giá</label>
                        <input type="text" class="form-control" placeholder="Enter ..." name="magiamgia" id="magiamgia">
                 </div>
                 <div class="form-group">
                        <label>Số tiền</label>
                        <input type="text" class="form-control" placeholder="Enter ..." name="sotien" id="sotien">
                 </div>
                 <div class="form-group">
                        <label>Loại</label>
                        <select class="form-control" name="loai" id="loai">
                         <option value="ti_le">Tỉ lệ %</option>
                 ...
                 <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="thoihan" name="thoihan" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-mask>
                  </div>
                  <!-- /.input group -->
                </div>
                  <div class="form-group">
                        <label>Cho phép</label>
                        <input type="checkbox" name="trangthai" id="tranhthai" value="1">
                 </div>
