          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form mã giảm giá</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" enctype="multipart/form-data" method="post" action="{{url('/admin/suama/'.$chitiet_ma->id)}}" name="themma" id="themma">
              	{{csrf_field()}}
                <div class="card-body">
                  
                 <div class="form-group">
                        <label>Mã giảm giá</label>
                        <input type="text" class="form-control" placeholder="Enter ..." name="magiamgia" id="magiamgia" value="{{$chitiet_ma->magiamgia}}">
                 </div>
                 <div class="form-group">
                        <label>Số tiền</label>
                        <input type="text" class="form-control" placeholder="Enter ..." name="sotien" id="sotien" value="{{$chitiet_ma->sotien}}">
                 </div>
                 <div class="form-group">
                        <label>Loại</label>
                        <select class="form-control" name="loai" id="loai">
                         <option value="ti_le" @if($chitiet_ma->loai=="ti_le") selected @endif value="Tỉ lệ">Tỉ lệ %</option>
                         <option value="thanh_tien" @if($chitiet_ma->loai=="thanh_tien") selected @endif value="Thành tiền">Thành tiền</option>
                 ...
                 <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="thoihan" name="thoihan" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-mask value="{{$chitiet_ma->thoihan}}">
                  </div>
                  <!-- /.input group -->
                </div>
                  <div class="form-group">
                        <label>Cho phép</label>
                        <input type="checkbox" name="trangthai" id="tranhthai" value="1" @if($chitiet_ma->trangthai=="1") checked @endif >
                 </div>
