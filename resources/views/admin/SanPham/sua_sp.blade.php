          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form sản phẩm</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" enctype="multipart/form-data" method="post" action="{{url('/admin/suasp/'.$chitiet_sp->id_sanpham)}}" name="suasp" id="suasp">
              	{{csrf_field()}}
                <div class="card-body">
                  <div class="form-group">
                        <label>Select</label>
                        <select class="form-control" name="id_loaisp">
                          <?php echo $loaisanpham_dropdown;?>
                          
                        </select>
                      </div>
                 <div class="form-group">
                        <label>Sản phẩm</label>
                        <input type="text" class="form-control" value="{{$chitiet_sp->ten_sanpham}}" placeholder="Enter ..." name="ten_sanpham" id="ten_sanpham">
                 </div>
                 <div class="form-group">
                        <label>Code</label>
                        <input type="text" class="form-control" value="{{$chitiet_sp->code_sanpham}}"  placeholder="Enter ..." name="code_sanpham" id="code_sanpham">
                 </div>
                 <div class="form-group">
                        <label>Màu sắc</label>
                        <input type="text" class="form-control" value="{{$chitiet_sp->mau_sanpham}}"  placeholder="Enter ..." name="mau_sanpham" id="mau_sanpham">
                 </div>
                 <div class="form-group">
                        <label>Miêu tả</label>
                        <textarea class="form-control" rows="3"  placeholder="Enter ..."  name="mieuta" id="mieuta">{{$chitiet_sp->mieuta}}</textarea>
                  </div>
                  <div class="form-group">
                        <label>Giá</label>
                        <input type="text" class="form-control" value="{{$chitiet_sp->price}}"  placeholder="Enter ..." name="price" id="price">
                 </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <input type="hidden" name="current_image" value="{{$chitiet_sp->anh}}">
                    ...
                    <img style="margin-left: 19%;
    margin-top: 3%;" src="{{asset('SanPham/small/'.$chitiet_sp->anh)}}" alt="Upload ảnh">
    <a href="{{url('/admin/xoaanh/'.$chitiet_sp->id_sanpham)}}" class="badge badge-danger" >Xóa</a>
                  </div>
